  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">My Applications</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-primary card-tabs">
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="all-applications-tab" data-toggle="pill" href="#all-applications" role="tab" aria-controls="all-applications" aria-selected="true"><i class="fas fa-eye"></i>View all applications</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="shortlisted-applications-tab" data-toggle="pill" href="#shortlisted-applications" role="tab" aria-controls="shortlisted-applications" aria-selected="false"><i class="fas fa-binoculars"></i>View all shortlisted applications</a>
                  </li>
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  <div class="tab-pane fade show active" id="all-applications" role="tabpanel" aria-labelledby="all-applications-tab">
        <div class="row">
          <div class="col-12">
          <!--  <div class="card">
             ...
             <!--  <div class="card-body table-responsive p-0" style="height: 500px;"> -->
              <h3><i class="fas fa-mail-bulk fa-3x"></i>All Applications</h3>
                  <div id="student_all_applications_body">
                  </div>
          </div>
        </div>
        <!-- /.row -->
                  </div>
                 <div class="tab-pane fade" id="shortlisted-applications" role="tabpanel" aria-labelledby="shortlisted-applications-tab">
...
Shortlisted applications
                  ...
                  <div id="student_shortlisted_applications_body">
                  </div>
                  </div>
...
$(document).ready(function(){
  $('[data-toggle="tooltip"]').tooltip();
   ...
   /*
   Student display all applications
    */
   $(document).ready(function(){
   $.ajax({
                  url: "resources/student_display_all_applications.php",
                  method: "POST",
                  success: function(data) {
                      $('#student_all_applications_body').html(data);                    
                  }
              });
});

   /*
   Student display shortlisted applications
    */
   $(document).ready(function(){
   $.ajax({
                  url: "resources/student_display_shortlisted_applications.php",
                  method: "POST",
                  success: function(data) {
                      $('#student_shortlisted_applications_body').html(data);                    
                  }
              });
});
   /*
 ...
 <div class="modal fade" id="student_job_view_modal" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="view_jobs_body">
              ...
              <!-- Modal body -->
              <div class="modal-body" id="view_job_modal_body" data-backdrop="static">
              </div>
