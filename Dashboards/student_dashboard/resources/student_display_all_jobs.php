...
*/    include '../../../connection.php';            
	$query1=$con->prepare("SELECT a.*,b.id,b.company_name FROM jobs AS a LEFT JOIN company as B on a.company_code=b.company_code WHERE job_status NOT IN ('Deleted')");
	$query1->execute();
	$output='';
	$query1->store_result();
		...
		<div class="card-body">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-2">'.$job_code.'</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-sm-1"> 
						<a type="button" name="viewJobBtn" id="viewJobBtn" value="view_jobs" job_id='.$job_id.' class="view_jobs action_icon" data-toggle="modal" data-target="#student_job_view_modal">
