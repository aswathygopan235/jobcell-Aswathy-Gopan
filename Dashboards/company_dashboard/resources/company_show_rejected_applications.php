...
$query=$con->prepare("SELECT a.*,b.id,b.job_position_name,b.job_location,c.first_name,c.last_name FROM job_application  AS a LEFT JOIN jobs AS b ON a.job_code=b.job_code LEFT JOIN student AS c ON a.student_code=c.student_code WHERE a.company_code=? AND a.application_status='Rejected' ");
