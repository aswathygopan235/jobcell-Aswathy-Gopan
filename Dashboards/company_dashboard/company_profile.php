...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php
        ...
        $query->bind_param("i",$_SESSION["user_company_id"]);
        $query->execute();
        $query->store_result();
          ...
          <div class="col-md-12">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-gradient-navy ">
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username"><?php echo $company_name;?></h3>
  ...
  <div class="callout callout-info">                
    ...
    <div class="row">
      ...
      <div class="col-sm-1">
          <a type="button" name="viewJobBtn" id="viewJobBtn" value="view_jobs"  class="view_jobs action_icon" href="company_view_one_job.php?id=<?php echo $row["id"];?>">
                      <span class="fas fa-tag job_profile_icon action_icon" data-toggle="tooltip" title="View job profile"></span>
                  </a>
          </div>
  </div>
</div>
