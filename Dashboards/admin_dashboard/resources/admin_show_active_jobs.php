...
$query1=$con->prepare("SELECT a.*,b.id,b.company_code,b.company_name FROM jobs AS a LEFT JOIN company as b ON a.company_code=b.company_code WHERE a.job_status='Active'");
 $output='  <h3><i class="fas fa-business-time fa-3x"></i>All active jobs</h3>';
 $query1->execute();
  $query1->store_result();
