        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <h3><i class="fas fa-user-graduate fa-3x"></i>Students</h3>
                <div id="admin_all_students_body">
                </div>
...
<script>
  ...
  $(document).ready(function(){
   $.ajax({
                  url: "resources/admin_show_all_students.php",
                  method: "POST",
                  success: function(data) {
                      $('#admin_all_students_body').html(data);                    
                  }
              });
}); 
</script>
